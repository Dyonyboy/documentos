<!DOCTYPE html>
<html dir="ltr" lang="pt" class="" lazy-loaded="true"><head>
    <meta charset="utf-8">
...
<iron-iconset-svg name="tab_resumption" size="20" style="display: none;">
  ...
  <body style="background-color: rgb(255, 248, 248);">
    ...
    <ntp-app realbox-width-behavior_="" most-visited-reflow-on-overflow-enabled_="" wide-modules-enabled_=""></ntp-app>
